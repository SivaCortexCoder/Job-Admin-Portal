...
const handleSubmit = (e) => {
  ...
  axios.post("https://job-admin-portal-21vs.onrender.com/new", formData)
    .then(() => {
      console.log("Job created successfully!");
      handleClose();
      
      return axios.get("https://job-admin-portal-21vs.onrender.com/jobs");
    })
    .then((res) => {
      setJobs(res.data);
    })
...
useEffect(()=>{
  setIsLoading(true)
  axios.get("https://job-admin-portal-21vs.onrender.com/jobs")
  .then(res=>{
    setJobs(res.data)
  })
  .catch(err=>{
